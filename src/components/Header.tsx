...
import { Settings, Calendar, Search, Moon, Sun, LogOut, Compass, GitFork, FileCode2, Menu, X, Package } from 'lucide-react';
...
const MENU_META: Record<HeaderMenuId, {
  ...
  apps: { icon: Package, labelZh: '我的应用', labelEn: 'My Apps' },
